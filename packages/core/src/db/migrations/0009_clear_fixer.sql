...
INSERT INTO `__new_nav_item`("id", "site_id", "type", "system_key", "label", "url", "placement", "position", "created_at", "updated_at") SELECT "id", "site_id", "type", "system_key", "label", "url", 'header', "position", "created_at", "updated_at" FROM `nav_item`;--> statement-breakpoint
