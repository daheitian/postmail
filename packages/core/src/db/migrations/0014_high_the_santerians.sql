...
INSERT INTO `__new_collection_directory_item`("id", "site_id", "type", "collection_id", "label", "url", "description", "position", "created_at", "updated_at") SELECT "id", "site_id", "type", "collection_id", "label", "url", NULL, "position", "created_at", "updated_at" FROM `collection_directory_item`;--> statement-breakpoint
