...
export interface Bindings {
  ...
  HEADER_NAV_MAX_VISIBLE?: EnvBindingValue;
  ...
  HOSTED_AUTH_BASE_URL?: EnvBindingValue;
  HOSTED_AUTH_PROVIDER_NAME?: EnvBindingValue;
  HOSTED_AUTH_SSO_SECRET?: EnvBindingValue;
  // Timeline
