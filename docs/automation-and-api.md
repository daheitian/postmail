...
A few public read endpoints don't need a token: `GET /api/collections`, `GET /api/collections/:id`, `GET /api/search`, `GET /api/public/posts`, `GET /api/public/posts/:slug`.
