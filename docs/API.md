...
- **Slugs**: Use the original URL slug to maintain link compatibility. If your old blog used paths like `/2024/01/my-post`, set `slug` to `2024-01-my-post` or a similar flat slug.
